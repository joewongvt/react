...
package object nodescala {
  ...
  implicit class FutureCompanionOps(val f: Future.type) extends AnyVal {
     ...
     *
     *  https://github.com/scala/scala/blob/v2.11.2/src/library/scala/concurrent/Future.scala#L505
     */
    ...
    def run()(f: CancellationToken => Future[Unit]): Subscription = {
      val ct:CancellationTokenSource = CancellationTokenSource()
  ...
  implicit class FutureOps[T](val f: Future[T]) extends AnyVal {
    ...
    def now: T = {
      try {
        ...
        case t:TimeoutException => throw new NoSuchElementException("future not completed")
      }
    }
